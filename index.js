        ...
        if (event.type == "message" && event.message.type == "text"){
          ...
          languageTranslator.translate(translateParams)
            .then(translationResult => {
              ...
              console.log(translationResult.body[0].translation);
              console.log(translationResult.body[0].translations.translation);
              console.log(translationResult.body[0].translations[0].translation);
              console.log(translationResult.body.word_count);
              console.log(translationResult.body[0].word_count);
